...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `Manabo Certificate #${certId}`,
    description: `Verify the authenticity of Manabo JLPT N5 certificate ${certId}.`,
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          <a href="/" className="text-2xl font-bold text-sakura font-display">Manabo</a>
        </div>
        ...
        {cert && !cert.revoked ? (
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
            ...
            <div className="space-y-4">
              ...
              <DetailRow label="Qualification" value="JLPT N5 — Manabo Accredited" />
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 text-center">
              <div className="inline-flex items-center gap-2 text-sm text-slate-500">
                ...
                Verified by Manabo · {new Date().getFullYear()}
              </div>
            </div>
          </div>
        ) : (
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 text-center">
            ...
            <p className="text-sm text-slate-400">
              ...
              <a href="mailto:support@Manabo.app" className="text-indigo-600 hover:underline">
                support@Manabo.app
              </a>
            </p>
          </div>
